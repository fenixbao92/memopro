package com.fenixbao92.memopro.service.oss;
...
/**
 * Create by fenixbao92 on 2019/5/16.
 */
@Service
public class OssService {
    ...
    private static String accessKeyId = "LTAIXhV1VGiOTxBm";
    private static String accessKeySecret = "6DIYxUL9bQQKi8WBgX8GZNJOu2yxuj";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "aliyun-oss-bucket-test";
