    ...
    <div>
        <el-form :rules="rules" :model="loginForm" class="login-container" label-position="left"
            ...
            <el-container direction="horizontal" type="flex" justify="space-around">
                <el-main width="40%">
                    <el-button icon="el-icon-search" @click="showRegister">注册</el-button>
                </el-main>
                <el-main>
                    <el-button icon="el-icon-search" @click="goGitHub">GitHub</el-button>
                </el-main>
            </el-container>
        </el-form>
        <el-dialog title="注册" :visible.sync="dialogFormVisible" @close="dialogFormVisible = false,loading=false">
            <el-form :model="registerForm" :rules="rulesRegister" ref="registerFormRef">
                ...
                <el-form-item label="密码" :label-width="formLabelWidth" prop="password">
                    <el-input type="password" prefix-icon="el-icon-edit" v-model="registerForm.password" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
